...
DATASETS = {
    "ho3d_v3": {"local": "/cat3_prod/ho3d_v3/frames"},
    "dexycb":  {"local": "/cat3_prod/dexycb/frames"},
    "hoi4d":   {"local": "/cat3_prod/hoi4d/frames"},
    "show3d":  {"local": "/cat3_prod/show3d/frames"},
}
OUT_DIR = "/cat3_prod/annotations"
...
def main():
    ...
    ap.add_argument("--datasets", default="ho3d_v3,dexycb,hoi4d")
